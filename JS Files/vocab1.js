...
document.getElementById( 'side-5' ).addEventListener( 'click', function() {
    ...
    document.getElementById( 'side-5' ).className = 'flip flip-side-6';
    document.getElementById("side-6").style.backgroundColor = "white";
...
document.getElementById( 'side-7' ).addEventListener( 'click', function() {
    ...
    document.getElementById("side-8").style.backgroundColor = "white";
...
document.getElementById( 'side-9' ).addEventListener( 'click', function() {
    ...
    document.getElementById("side-10").style.backgroundColor = "white";
...
document.getElementById( 'side-11' ).addEventListener( 'click', function() {
    ...
    document.getElementById("side-12").style.backgroundColor = "white";
...
document.getElementById( 'side-13' ).addEventListener( 'click', function() {
    ...
    document.getElementById("side-14").style.backgroundColor = "white";
...
document.getElementById( 'side-15' ).addEventListener( 'click', function() {
    ...
    document.getElementById("side-16").style.backgroundColor = "white";
